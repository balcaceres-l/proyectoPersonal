<template>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <!-- Main Content -->
        <main class="max-w-[96%] mx-auto px-2 sm:px-3 lg:px-4 py-4">
            <!-- Profile Header -->
                    ...
                    <div class="flex flex-col md:flex-row md:items-center mb-6">
                        <div class="relative mb-4 md:mb-0">
                            <div class="w-24 h-24 bg-white dark:bg-gray-800 rounded-full p-1 shadow-lg">
                                <div class="w-full h-full bg-linear-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center">
                                    <span class="text-white text-2xl font-bold">{{ currentUser.initials }}</span>
                                </div>
                            </div>
                            <button class="absolute bottom-1 right-1 bg-indigo-600 hover:bg-indigo-700 text-white p-1.5 rounded-full shadow-lg">
                        ...
                        <div class="md:ml-6 flex-1">
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ currentUser.name }}</h1>
                            <p class="text-lg text-gray-600 dark:text-gray-400 mb-1">{{ currentUser.title }}</p>
                        ...
                        <div class="mt-4 md:mt-0">
                            <button 
                                ...
                                class="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-lg font-medium transition-colors"
                            >
            ...
            <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
                ...
                <div class="xl:col-span-3 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                        ...
                        <div v-if="!editMode">
                            <p class="text-gray-700 dark:text-gray-300">{{ currentUser.about }}</p>
                        </div>
                        <div v-else>
                            <textarea
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                        ...
                        <div class="space-y-6">
                            <div 
                                v-for="(exp, index) in currentUser.experience" 
                                :key="index"
                            ...
                            >
                                ...
                                <div class="flex-1">
                                    <div v-if="!editMode">
                                        ...
                                        <p class="text-gray-700 dark:text-gray-300 text-sm">{{ exp.description }}</p>
                                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
                        ...
                        <div class="space-y-4">
                            <div 
                                v-for="(edu, index) in currentUser.education" 
                                :key="index"
                                class="flex items-start"
                            >
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <div v-if="!editMode">
                                    <span class="text-gray-700 dark:text-gray-300">{{ currentUser.email }}</span>
                                </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div v-if="!editMode">
                                    <span class="text-gray-700 dark:text-gray-300">{{ currentUser.phone }}</span>
                                </div>
                                <div v-else class="flex-1">
                                    <input
                            ...
                            <div class="flex items-center">
                                ...
                                <div v-if="!editMode">
                                    <span class="text-gray-700 dark:text-gray-300">{{ currentUser.location }}</span>
                                </div>
                                <div v-else class="flex-1">
                                    <input
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
                        ...
                        <div class="space-y-3">
                            <div v-for="(link, index) in currentUser.socialLinks" :key="index" class="flex items-center">
...
const currentUser = ref({
    ...
    phone: '+503 7226 8294',
    about: 'Desarrollador Full Stack con más de 5 años de experiencia en tecnologías web modernas. Especializado en Vue.js, Node.js y bases de datos. Me apasiona crear aplicaciones web escalables y experiencias de usuario excepcionales.',
    skills: ['Vue.js', 'JavaScript', 'Node.js', 'MongoDB', 'Express', 'HTML', 'CSS', 'Git', 'Docker', 'AWS'],
    experience: [
    {
        position: 'Desarrollador Senior Full Stack',
        company: 'TechCorp SL',
        period: '2021 - Presente',
        description: 'Desarrollo de aplicaciones web complejas utilizando Vue.js y Node.js. Liderazgo de un equipo de 4 desarrolladores junior.'
    },
    {
        position: 'Desarrollador Frontend',
        company: 'StartupInnovate',
        period: '2019 - 2021',
        description: 'Desarrollo de interfaces de usuario responsivas y optimizadas. Colaboración estrecha con el equipo de diseño UX/UI.'
    }
    ],
    education: [
    {
    ...
    socialLinks: [
        { platform: 'LinkedIn', url: 'https://linkedin.com/in/davidsolito' },
        { platform: 'GitHub', url: 'https://github.com/davidsolito' },
        { platform: 'Twitter', url: 'https://twitter.com/davidsolito' }
    ]
})
...
// Methods
const addExperience = () => {
    currentUser.value.experience.push({
        position: '',
        company: '',
        period: '',
        description: ''
...
const removeExperience = (index) => {
    currentUser.value.experience.splice(index, 1)
}

const addEducation = () => {
    currentUser.value.education.push({
        degree: '',
        institution: '',
        period: ''
    })
...
const removeEducation = (index) => {
    currentUser.value.education.splice(index, 1)
}
...
const addSocialLink = () => {
    currentUser.value.socialLinks.push({
        platform: '',
        url: ''
    })
}
...
const removeSocialLink = (index) => {
    currentUser.value.socialLinks.splice(index, 1)
}
...
const getSocialIcon = (platform) => {
    ...
    return icons[platform] || TwitterIcon
}
</script>