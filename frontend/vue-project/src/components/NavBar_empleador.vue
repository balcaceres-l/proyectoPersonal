        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="shrink-0 flex items-center">
                    <router-link to="/empleador/dashboard"
                        class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 transition-colors">
                        MiApp
                    </router-link>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <!-- Notifications -->
                    <button
                        class="p-2 rounded-full text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div class="relative profile-dropdown">
                        <button @click="toggleProfileMenu"
                            ...
                            <span class="hidden md:block text-base font-medium text-gray-700 dark:text-gray-300">{{
                                userName }}</span>
                        ...
                        <transition enter-active-class="transition ease-out duration-200"
                            ...
                            <div v-if="showProfileMenu"
                                ...
                                <div class="py-2">
                                    <router-link to="/empleador/perfil"
...
// Navigation items para empleador
